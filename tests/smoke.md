...
- Codex alias skills: copy `skills/crystallize/` and `skills/distill/` to `~/.codex/skills/crystallize/` and `~/.codex/skills/distill/`, restart Codex, invoke `$crystallize` or `$distill`.
...
- Plugin manifests and platform-specific alias mirrors must not exist in this repo; they create duplicate discovery risk.
